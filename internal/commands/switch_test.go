...
func TestSwitchCommandHelp(t *testing.T) {
	...
	// Check long description mentions shell integration
	if !strings.Contains(cmd.Long, "shell integration") {
		t.Errorf("long description should mention shell integration: %s", cmd.Long)
	}
}
