...
A CLI for managing git worktrees with bare repository support.

git-wt wraps `git` and `gh` to streamline the [bare repo + worktree workflow](https://nicknisi.com/posts/git-worktrees/) for developers who frequently switch context in collaborative environments.
